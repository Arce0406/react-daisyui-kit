        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-8 rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Single Select</label>
              <ComboInput
                value={singleValue}
              ...
              />
              <p className="text-sm text-gray-600 dark:text-gray-400">Current value: {singleValue || '-'}</p>
            </div>

            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Multiple Select</label>
              <ComboInput
                value={multiValue}
                onChange={(value) => setMultiValue(value as string[])}
                options={options}
                multiple
                placeholder="Select multiple or type custom"
              />
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Current values: {multiValue.length > 0 ? multiValue.join(', ') : '-'}
              </p>
            </div>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                ...
                <td className="py-3 px-4">Current value (string for single, string[] for multiple)</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                <td className="py-3 px-4 font-mono text-blue-600 dark:text-blue-400">onChange</td>
                <td className="py-3 px-4 font-mono">(value: string | string[]) =&gt; void</td>
                <td className="py-3 px-4 font-mono">-</td>
                <td className="py-3 px-4">Called with the next value</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                <td className="py-3 px-4 font-mono text-blue-600 dark:text-blue-400">options</td>
                <td className="py-3 px-4 font-mono">(string | {'{ value: string; label?: string }'})[]</td>
                <td className="py-3 px-4 font-mono">[]</td>
                <td className="py-3 px-4">Dropdown options used for filtering and selection</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                ...
                <td className="py-3 px-4">Enable multi-select mode with tags</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                <td className="py-3 px-4 font-mono text-blue-600 dark:text-blue-400">allowClear</td>
                <td className="py-3 px-4 font-mono">boolean</td>
                <td className="py-3 px-4 font-mono">true</td>
                <td className="py-3 px-4">Show clear button when there is a value</td>
              </tr>
              <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                <td className="py-3 px-4 font-mono text-blue-600 dark:text-blue-400">maxDropdownHeight</td>
                <td className="py-3 px-4 font-mono">number</td>
                <td className="py-3 px-4 font-mono">200</td>
                <td className="py-3 px-4">Maximum dropdown height in pixels</td>
              </tr>
            </tbody>
          </table>
        </div>
